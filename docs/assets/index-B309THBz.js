...
${w("sudo reboot","makes the earth spin a bit faster")}
            ...
            `:e==="ls"?"horace1-14.txt&emsp;horace1-22.txt&emsp;catullus70.txt&emsp;personal1.txt&emsp;personal2.txt&emsp;personal3.txt":e.includes("cat")?_e(e):e==="clear"?"clear":e==="sudo reboot"?"reboot":`psh: command not found: ${e}`}function w(e,t){return`${`  ${e.padEnd(20)}`} ${t}`}function _e(e){const t=e.trim().split(/\s+/);if(t.length>2)return"psh: too many args, try just one file";if(t[0]!="cat")return`psh: command not found: ${e}`;if(t.length===1)return"usage: &#96;cat [FILENAME]&#96;";for(const n of be)if(t[1].includes(n.name))return n.content}function G(e,t,n){const s=e.slice();return s[11]=t[n],s}function Q(e){let t,n=e[11].message+"";return{c(){t=d("p")},m(s,o){x(s,t,o),t.innerHTML=n},p(s,o){o&1&&n!==(n=s[11].message+"")&&(t.innerHTML=n)},d(s){s&&k(t)}}}function X(e){let t,n,s,o,r,i,a,l,c;return{c(){t=d("form"),n=d("p"),s=d("span"),s.textContent="user",o=j(`@weewaa-land-352
