var ae=Object.defineProperty;var re=(e,t,n)=>t in e?ae(e,t,{enumerable:!0,configurable:!0,writable:!0,value:n}):e[t]=n;var C=(e,t,n)=>re(e,typeof t!="symbol"?t+"":t,n);(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))s(o);new MutationObserver(o=>{for(const a of o)if(a.type==="childList")for(const i of a.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&s(i)}).observe(document,{childList:!0,subtree:!0});function n(o){const a={};return o.integrity&&(a.integrity=o.integrity),o.referrerPolicy&&(a.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?a.credentials="include":o.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function s(o){if(o.ep)return;o.ep=!0;const a=n(o);fetch(o.href,a)}})();function g(){}function ee(e){return e()}function V(){return Object.create(null)}function $(e){e.forEach(ee)}function te(e){return typeof e=="function"}function F(e,t){return e!=e?t==t:e!==t||e&&typeof e=="object"||typeof e=="function"}function oe(e){return Object.keys(e).length===0}function p(e,t){e.appendChild(t)}function x(e,t,n){e.insertBefore(t,n||null)}function k(e){e.parentNode&&e.parentNode.removeChild(e)}function ie(e,t){for(let n=0;n<e.length;n+=1)e[n]&&e[n].d(t)}function d(e){return document.createElement(e)}function H(e){return document.createTextNode(e)}function ne(){return H(" ")}function A(e,t,n,s){return e.addEventListener(t,n,s),()=>e.removeEventListener(t,n,s)}function le(e){return function(t){return t.preventDefault(),e.call(this,t)}}function w(e,t,n){n==null?e.removeAttribute(t):e.getAttribute(t)!==n&&e.setAttribute(t,n)}function ue(e){return Array.from(e.childNodes)}function D(e,t){e.value=t??""}function S(e,t,n,s){n==null?e.style.removeProperty(t):e.style.setProperty(t,n,"")}let q;function I(e){q=e}const v=[],U=[];let _=[];const Y=[],ce=Promise.resolve();let P=!1;function fe(){P||(P=!0,ce.then(se))}function j(e){_.push(e)}const T=new Set;let b=0;function se(){if(b!==0)return;const e=q;do{try{for(;b<v.length;){const t=v[b];b++,I(t),he(t.$$)}}catch(t){throw v.length=0,b=0,t}for(I(null),v.length=0,b=0;U.length;)U.pop()();for(let t=0;t<_.length;t+=1){const n=_[t];T.has(n)||(T.add(n),n())}_.length=0}while(v.length);for(;Y.length;)Y.pop()();P=!1,T.clear(),I(e)}function he(e){if(e.fragment!==null){e.update(),$(e.before_update);const t=e.dirty;e.dirty=[-1],e.fragment&&e.fragment.p(e.ctx,t),e.after_update.forEach(j)}}function de(e){const t=[],n=[];_.forEach(s=>e.indexOf(s)===-1?t.push(s):n.push(s)),n.forEach(s=>s()),_=t}const L=new Set;let me;function N(e,t){e&&e.i&&(L.delete(e),e.i(t))}function K(e,t,n,s){if(e&&e.o){if(L.has(e))return;L.add(e),me.c.push(()=>{L.delete(e)}),e.o(t)}}function R(e){return(e==null?void 0:e.length)!==void 0?e:Array.from(e)}function W(e){e&&e.c()}function B(e,t,n){const{fragment:s,after_update:o}=e.$$;s&&s.m(t,n),j(()=>{const a=e.$$.on_mount.map(ee).filter(te);e.$$.on_destroy?e.$$.on_destroy.push(...a):$(a),e.$$.on_mount=[]}),o.forEach(j)}function M(e,t){const n=e.$$;n.fragment!==null&&(de(n.after_update),$(n.on_destroy),n.fragment&&n.fragment.d(t),n.on_destroy=n.fragment=null,n.ctx=[])}function pe(e,t){e.$$.dirty[0]===-1&&(v.push(e),fe(),e.$$.dirty.fill(0)),e.$$.dirty[t/31|0]|=1<<t%31}function J(e,t,n,s,o,a,i=null,r=[-1]){const l=q;I(e);const c=e.$$={fragment:null,ctx:[],props:a,update:g,not_equal:o,bound:V(),on_mount:[],on_destroy:[],on_disconnect:[],before_update:[],after_update:[],context:new Map(t.context||(l?l.$$.context:[])),callbacks:V(),dirty:r,skip_bound:!1,root:t.target||l.$$.root};i&&i(c.root);let u=!1;if(c.ctx=n?n(e,t.props||{},(f,E,...O)=>{const m=O.length?O[0]:E;return c.ctx&&o(c.ctx[f],c.ctx[f]=m)&&(!c.skip_bound&&c.bound[f]&&c.bound[f](m),u&&pe(e,f)),E}):[],c.update(),u=!0,$(c.before_update),c.fragment=s?s(c.ctx):!1,t.target){if(t.hydrate){const f=ue(t.target);c.fragment&&c.fragment.l(f),f.forEach(k)}else c.fragment&&c.fragment.c();t.intro&&N(e.$$.fragment),B(e,t.target,t.anchor),se()}I(l)}class z{constructor(){C(this,"$$");C(this,"$$set")}$destroy(){M(this,1),this.$destroy=g}$on(t,n){if(!te(n))return g;const s=this.$$.callbacks[t]||(this.$$.callbacks[t]=[]);return s.push(n),()=>{const o=s.indexOf(n);o!==-1&&s.splice(o,1)}}$set(t){this.$$set&&!oe(t)&&(this.$$.skip_bound=!0,this.$$set(t),this.$$.skip_bound=!1)}}const ge="4";typeof window<"u"&&(window.__svelte||(window.__svelte={v:new Set})).v.add(ge);function we(e){let t;return{c(){t=d("div"),t.innerHTML='<div class="buttons-absolute svelte-1ve164l"><div class="button red svelte-1ve164l"></div> <div class="button yellow svelte-1ve164l"></div> <div class="button green svelte-1ve164l"></div></div> <div class="github-link" style="color: #898989;"><a href="https://github.com/jimothych" target="_blank" style="text-decoration: none;"><i class="fa-brands fa-github" style="color: #898989;"></i> github.com/jimothych</a></div>',w(t,"class","header svelte-1ve164l")},m(n,s){x(n,t,s)},p:g,i:g,o:g,d(n){n&&k(t)}}}class ye extends z{constructor(t){super(),J(this,t,null,we,F,{})}}const be=[{name:"horace1-14",content:`<span style="white-space: pre-wrap">
...
</span>`}];function h(e){return new Promise(t=>setTimeout(t,e))}function ve(e){return e?e==="help"?`<p style="white-space:pre-wrap">
...
${y("sudo reboot","makes the earth spin a bit faster")}
            ...
            `:e==="ls"?"horace1-14.txt&emsp;horace1-22.txt&emsp;catullus70.txt&emsp;personal1.txt&emsp;personal2.txt&emsp;personal3.txt":e.includes("cat")?_e(e):e==="clear"?"clear":e==="sudo reboot"?"reboot":`psh: command not found: ${e}`:null}function y(e,t){return`${`  ${e.padEnd(20)}`} ${t}`}function _e(e){const t=e.trim().split(" ");if(t.length>2)return`psh: command not found: ${e}`;if(t[0]!="cat")return`psh: command not found: ${e}`;for(const n of be)if(t[1].includes(n.name))return n.content}function G(e,t,n){const s=e.slice();return s[11]=t[n],s}function Q(e){let t,n=e[11].message+"";return{c(){t=d("p")},m(s,o){x(s,t,o),t.innerHTML=n},p(s,o){o&1&&n!==(n=s[11].message+"")&&(t.innerHTML=n)},d(s){s&&k(t)}}}function X(e){let t,n,s,o,a,i,r,l,c;return{c(){t=d("form"),n=d("p"),s=d("span"),s.textContent="user",o=H(`@weewaa-land-352
      `),a=d("span"),a.textContent="~/jameschang ",i=H(`›
      `),r=d("input"),S(s,"color","#F28B50"),S(a,"color","#898989"),w(r,"spellcheck","false"),w(r,"type","text"),S(r,"display","inline"),w(r,"id","mainInput"),w(t,"autocomplete","off"),w(t,"name","mainForm")},m(u,f){x(u,t,f),p(t,n),p(n,s),p(n,o),p(n,a),p(n,i),p(n,r),D(r,e[1]),l||(c=[A(r,"input",e[4]),A(t,"submit",le(e[3]))],l=!0)},p(u,f){f&2&&r.value!==u[1]&&D(r,u[1])},d(u){u&&k(t),l=!1,$(c)}}}function $e(e){let t,n,s,o,a=R(e[0]),i=[];for(let l=0;l<a.length;l+=1)i[l]=Q(G(e,a,l));let r=e[2]&&X(e);return{c(){t=d("div");for(let l=0;l<i.length;l+=1)i[l].c();n=ne(),r&&r.c(),w(t,"class","terminal-interface svelte-g5mbzd")},m(l,c){x(l,t,c);for(let u=0;u<i.length;u+=1)i[u]&&i[u].m(t,null);p(t,n),r&&r.m(t,null),s||(o=[A(t,"click",Z),A(t,"mouseover",Z)],s=!0)},p(l,[c]){if(c&1){a=R(l[0]);let u;for(u=0;u<a.length;u+=1){const f=G(l,a,u);i[u]?i[u].p(f,c):(i[u]=Q(f),i[u].c(),i[u].m(t,n))}for(;u<i.length;u+=1)i[u].d(1);i.length=a.length}l[2]?r?r.p(l,c):(r=X(l),r.c(),r.m(t,null)):r&&(r.d(1),r=null)},i:g,o:g,d(l){l&&k(t),ie(i,l),r&&r.d(),s=!1,$(o)}}}function Z(e){try{e.currentTarget.querySelector("input").focus()}catch{}}function ke(e,t,n){let s=[];function o(m){n(0,s=[...s,m])}let a="",i=null,r=!1;async function l(){await h(100),o({message:"<em>salvete amici!</em>"}),await h(1e3),o({message:"Booting environment..."}),await h(1300),n(2,r=!0),c()}async function c(){await h(0),document.getElementById("mainInput").focus(),await h(150),n(1,a="h"),await h(121),n(1,a="he"),await h(154),n(1,a="hel"),await h(101),n(1,a="help"),await h(174),await u()}async function u(){console.log(a),i=a,n(1,a=""),n(2,r=!1);const m=ve(i);if(o({message:`<span style="color: #F28B50">user</span>@weewaa-land-352
            <span style="color: #898989"> ~/jameschang <span>
            <span style="color: #d3b0c3">› ${i}</span>`}),m){if(m==="reboot"&&window.location.reload(),m==="clear"){E();return}o({message:m})}await f()}async function f(){await h(150),n(2,r=!0),await h(0),document.getElementById("mainInput").focus()}async function E(){n(0,s=[]),n(0,s),await f()}l();function O(){a=this.value,n(1,a)}return[s,a,r,u,O]}class Ie extends z{constructor(t){super(),J(this,t,ke,$e,F,{})}}function xe(e){let t,n,s,o,a,i;return s=new ye({}),a=new Ie({}),{c(){t=d("main"),n=d("div"),W(s.$$.fragment),o=ne(),W(a.$$.fragment),w(n,"class","main-container svelte-kseypu")},m(r,l){x(r,t,l),p(t,n),B(s,n,null),p(n,o),B(a,n,null),i=!0},p:g,i(r){i||(N(s.$$.fragment,r),N(a.$$.fragment,r),i=!0)},o(r){K(s.$$.fragment,r),K(a.$$.fragment,r),i=!1},d(r){r&&k(t),M(s),M(a)}}}class Ee extends z{constructor(t){super(),J(this,t,null,xe,F,{})}}new Ee({target:document.getElementById("app")});
